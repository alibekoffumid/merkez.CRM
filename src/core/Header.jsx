...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-30 w-full pl-28 transition-all duration-300">
