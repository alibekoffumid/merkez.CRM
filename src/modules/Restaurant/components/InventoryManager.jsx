...
const InventoryManager = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header Actions - Fixed sticky at top-48 (exactly under tabs) */}
      <div className="sticky top-[48px] bg-white z-20 py-4 -mx-6 px-6 border-b border-gray-100 shadow-sm">
        ...
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-merkez-blue transition-all shadow-sm"
            value={searchTerm}
        ...
        <button
          ...
          className="w-full md:w-auto px-6 py-2.5 bg-merkez-blue text-white rounded-lg text-sm font-bold hover:bg-blue-600 transition-all flex items-center justify-center shadow-lg shadow-blue-200/50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm flex items-center space-x-4">
          <div className="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center text-merkez-blue">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-sm flex items-center space-x-4">
          <div className="w-12 h-12 bg-green-50 rounded-lg flex items-center justify-center text-merkez-green">
      ...
      {/* Inventory Table with LOCAL SCROLL - Fixed math errors */}
      <div className="bg-white rounded-lg border border-gray-100 shadow-xl mt-6 overflow-hidden">
        <div className="overflow-x-auto overflow-y-auto scrollbar-hide" style={{ maxHeight: 'calc(100vh - 300px)' }}>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div className="space-y-1">
                ...
                <input
                  required
                  type="text"
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-merkez-blue"
                  value={formData.name}
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="number"
                      step="0.01"
                      className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-merkez-blue"
              ...
              <div className="pt-4 flex space-x-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gray-50 text-gray-600 rounded-lg text-sm font-bold hover:bg-gray-100 transition-all"
                >
                  {t('common.cancel')}
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-merkez-blue text-white rounded-lg text-sm font-extrabold hover:bg-blue-600 transition-all shadow-md flex items-center justify-center disabled:opacity-50"
                >
