                        ...
                        >
                          ...
                          <div className="flex items-center h-full relative pl-6 pr-8 gap-8">
                            ...
                            <button 
                              ...
                              className="absolute right-6 p-2 bg-rose-50 hover:bg-rose-500 hover:text-white text-rose-600 rounded-xl opacity-0 group-hover/app:opacity-100 transition-all pointer-events-auto shadow-sm"
                              title="Delete"
                            >
                              <X className="w-4 h-4" />
                            </button>
