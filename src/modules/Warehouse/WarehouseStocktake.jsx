        ...
        <div className="space-y-6 flex-1 flex flex-col">
          {portalTarget && ReactDOM.createPortal(
            <button
              ...
              className="bg-merkez-blue text-white px-3.5 py-2 h-[38px] rounded-lg text-xs font-bold hover:bg-blue-600 transition-colors flex items-center justify-center shadow-md shadow-blue-600/10 whitespace-nowrap w-full border border-transparent"
            >
