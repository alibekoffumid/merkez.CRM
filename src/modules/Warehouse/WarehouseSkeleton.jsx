        ...
        <thead className="sticky top-0 bg-gray-50/90 backdrop-blur-sm z-10">
          <tr className="border-b border-gray-100 text-[10px] uppercase text-gray-400 tracking-wider">
            <th className="pl-8 pr-2 py-4 w-10">
              <div className="w-4 h-4 rounded shimmer-element" />
            </th>
            <th className="font-medium px-2 py-4">MƏHSUL SERİYA</th>
            <th className="font-medium px-2 py-4">RƏNG / ÖLÇÜ</th>
            <th className="font-medium px-2 py-4">BARKOD</th>
            <th className="font-medium px-2 py-4">TƏDARÜKÇÜ</th>
            <th className="font-medium px-2 py-4">ZAVOD QİYMƏTİ</th>
            <th className="font-medium px-2 py-4">MAYA QİYMƏTİ</th>
            <th className="font-medium px-2 py-4">SATIŞ QİYMƏTİ</th>
            <th className="font-medium px-2 py-4">ƏLAVƏ MƏLUMAT</th>
            <th className="font-medium px-2 py-4">STOK</th>
            <th className="font-medium px-2 py-4">STATUS</th>
            <th className="font-medium px-2 py-4 pr-6 text-right">ƏMƏLİYYATLAR</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-50/80">
          {rows.map((_, idx) => (
            <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
              ...
              <td className="px-2 py-4">
                <div className="w-16 h-3 rounded shimmer-element opacity-70" />
              </td>
              <td className="px-2 py-4">
      ...
      <div className="md:hidden p-4 space-y-3">
        {rows.slice(0, 6).map((_, idx) => (
          <div key={idx} className="p-4 bg-white rounded-xl border border-gray-100 space-y-3 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              <div className="w-28 h-3 rounded shimmer-element" />
