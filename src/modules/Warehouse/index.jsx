...
import { Search, Plus, Filter, AlertTriangle, CheckCircle2, FolderTree, ArrowRight, MoreVertical, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6 flex flex-col h-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="bg-white border text-gray-600 border-gray-200 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors flex items-center shadow-sm"
          >
          ...
          <button
            ...
            className="bg-merkez-blue text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-600 transition-colors flex items-center shadow-sm"
          >
      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        ...
        <div className="w-64 bg-white rounded-xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] border border-gray-50 p-4 flex flex-col">
          ...
          <button
            onClick={() => setShowAddCategory(true)}
            className="mt-4 w-full py-2 border-2 border-dashed border-gray-200 text-gray-400 rounded-lg text-sm font-medium hover:text-merkez-blue hover:border-merkez-blue transition-colors flex items-center justify-center"
          >
          ...
          <div className="flex-1 overflow-auto">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-400 gap-3">
                ...
                <button
                  onClick={() => setShowAddProduct(true)}
                  className="px-4 py-2 bg-merkez-blue text-white rounded-lg text-sm font-medium hover:bg-blue-600 transition-colors shadow-sm"
                >
